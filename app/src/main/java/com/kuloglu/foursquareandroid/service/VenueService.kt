...
interface VenueService {
    ...
    fun getVenue(@Query("section") type: String, @Query("near") location: String): Observable<FourSquareResult>

    @GET("venues/explore?client_id=${FourSquare.CLIENT_ID}&client_secret=${FourSquare.CLIENT_SECRET}&v=20180323&limit=100")
    fun getVenueCurrentLocation(@Query("section") type: String, @Query("ll") location: String): Observable<FourSquareResult>
}